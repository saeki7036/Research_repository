    ...
    private void OnGUI()
    {
        using (new EditorGUILayout.VerticalScope())
        {
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                if (GUILayout.Button("  �}�b�v��ǉ�", GUILayout.MaxWidth(120f), GUILayout.MaxHeight(20f)))
                {
                ...
                if (GUILayout.Button("Agent��ǉ�", GUILayout.MaxWidth(120f), GUILayout.MaxHeight(20f)))
                {
        ...
        using (new EditorGUILayout.HorizontalScope(GUILayout.MaxWidth(20f)))
        {
            ...
            using (new EditorGUILayout.HorizontalScope(GUILayout.MaxWidth(300f)))
            {
                ...
                {
                    EditorGUILayout.LabelField("    �͈͐ݒu", GUILayout.MinWidth(180f));
                    using (new EditorGUILayout.HorizontalScope())
                    {
                        using (new EditorGUILayout.VerticalScope())
                        {
                            ...
                            if (GUILayout.Button("�ݒu", GUILayout.MaxWidth(40f)))
                            {
                        ...
                        using (new EditorGUILayout.VerticalScope())
                        {
                            ...
                            EditorGUILayout.LabelField("�E��", GUILayout.MaxWidth(30f));
                        }
                    ...
                    {
                        EditorGUILayout.LabelField("�G�[�W�F���g���S�[��", GUILayout.MinWidth(180f));
                        using (var scroll = new EditorGUILayout.ScrollViewScope(scrollPosition, GUILayout.MinWidth(180f)))
                        {
                            ...
                            for (int i = 0; i < this.BaseData.preset[Slider_Value_Map].Agents.Length; i++)
                            {
                                ...
                                using (new EditorGUILayout.HorizontalScope())
                                {
                                    ...
                                    using (new EditorGUILayout.VerticalScope())
                                    {
                                        EditorGUILayout.LabelField("�X�^�[�g", GUILayout.MaxWidth(40f));
                                        EditorGUILayout.LabelField(" �S�[�� ", GUILayout.MaxWidth(40f));
